        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                'Quickly add your events & easy way to switch between month & week view.',
                textAlign: TextAlign.center,
                style: TextStyle(
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                'Quickest way to offload ideas, thoughts, and to-dos withoud losing focus',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black26,
                  fontSize: 18.0,
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                'Task list help you make the most of your day and get things done',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black26,
                  fontSize: 18.0,
